...
if [ $CIRCLE_BRANCH = 'master' ]; then
    ...
    docker build -f $HOMEPATH/webserver/Dockerfile.dist -t angmerica/todo-client:webserver-production $HOMEPATH/webserver/
    ...
    docker build -f $HOMEPATH/webserver/Dockerfile.dist -t angmerica/todo-client:webserver-staging $HOMEPATH/webserver/
else
    ...
    docker build -f $HOMEPATH/webserver/Dockerfile.dist -t angmerica/todo-client:webserver-develop $HOMEPATH/webserver/
fi
